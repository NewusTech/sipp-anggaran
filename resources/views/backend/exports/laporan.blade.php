...
<div class="table-responsive p-0 text-center">
    <div class="col mt-3">
        <table class="table table-bordered alzgn-middle">
            <tr>
                <th colspan="12" style="text-align:center; font-weight: bold;">DAFTAR KEGIATAN DINAS PUPR
                    {{ $bidang && $bidang_id ? $bidang[0]->name : 'KABUPATEN TULANG BAWANG BARAT' }} T.A
                    {{ $bidang && $bidang->count() > 0 ? $bidang[0]->kegiatan[0]->tahun ?? '' : '' }}
