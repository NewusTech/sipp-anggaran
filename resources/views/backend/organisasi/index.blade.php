        ...
        <div class="card">
            <div class="card-body">
                <div class="card-action-right">
									<button id="addorganisasi" class="btn btn-primary btn-sm btn-add" data-toggle="modal" data-target="#modal-lg-create"><i class="fas fa-plus"></i> Tambah Organisasi</button>
								</div>
                <div class="row">
                    <h4 class="text-darkblue"><strong> DATA ORGANISASI </strong></h4>
                </div>
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    <li class="nav-item">
                    <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Daftar <Obj></Obj>Organisasi</a>
                    </li>
                </ul>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table id="example1" class="table ">
                                    <thead>
                                    <tr>
                                        <th style="width: 80%; padding:1rem 2.25rem;">Nama organisasi</th>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control" name="name" value="{{$item->name}}" placeholder="Silahkan masukan nama organisasi" required>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="modal-delete-{{$item->id}}">
                                        <form action="{{ route('backend.organisasi.destroy', $item->id) }}" method="POST" id="delete_organisasi">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title"><strong> Hapus Organisasi </strong></h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
            ...
            <form action="{{ route('backend.organisasi.store') }}" method="POST" id="submit_organisasi">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <label class="text-darkblue">Nama organisasi</label>
                      <input type="text" class="form-control" name="name" placeholder="Silahkan masukan nama organisasi" required>
                    </div>
                    <span class="text-gray">*Tidak boleh mengandung karakter khusus</span>
                  </div>
                </div>
