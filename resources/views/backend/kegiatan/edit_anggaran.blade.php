...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row mx-0">
                    <h4 class="text-darkblue"><a href="{{route('backend.kegiatan.index')}}" class="btn btn-default rounded"><i class="fas fa-arrow-left"></i></a><strong class="h5 text-bold"> PROGRES PEKERJAAN </strong>
                    </h4>
                </div>
