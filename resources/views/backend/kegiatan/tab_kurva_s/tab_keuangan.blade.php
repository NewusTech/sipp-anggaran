<div class="tab-pane fade show {{session('tab') == 'keuangan'? 'active' : ''}}" id="custom-content-below-keuangan" role="tabpanel" aria-labelledby="custom-content-below-keuangan-tab">
    <div class="row">
        <div class="col-md-6">
            <h4>Rencana Keuangan</h4>
            <div class="container">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="p-2">
                                    ...
                                    <td class="p-2">
                                        @can('ubah kurva')
                                        <input type="text" class="form-control form-control-sm" name="data[{{ $loop->index }}][fisik]" value="{{ $dataKurvaS->fisik}}" pattern="^[0-9]*\.?[0-9]+$" title="Hanya angka dan titik desimal yang diizinkan">
                                        @else
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-body">
                <div class="chart">
                    <canvas id="kurvaKeuangan" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
            </div>
        </div>
    </div>
