<div class="tab-pane fade show {{ session('tab') == 'dokumentasi' ? 'active' : '' }}" id="custom-content-above-dokumentasi"
    role="tabpanel" aria-labelledby="custom-content-below-dokumentasi-tab">
    <div class="col-12">
                        ...
                        <td>
                            @if ($isEdit)
                                <div class="d-flex gap-2">
                                    <button type="button" style="color: white; margin-right: 5px" class="btn btn-warning"
                                        data-toggle="modal" data-target="#modal-lg-edit-file-{{ $dok->id }}"><i
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            placeholder="Silahkan masukan keterangan progres" required>
                                                    </div>
                                                    <div class="form-group">
