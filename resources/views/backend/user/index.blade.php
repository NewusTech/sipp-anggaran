            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-action-right">
                        <button id="addUser" class="btn btn-primary btn-sm btn-add" data-toggle="modal"
                            data-target="#modal-lg-create"><i class="fas fa-plus"></i> Tambah User</button>
                    </div>
                    <div class="row">
                    ...
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill"
                                ...
                                aria-selected="true">Daftar User</a>
                        </li>
                    </ul>
                                    ...
                                    <table id="example1" class="table ">
                                        ...
                                        <tbody>
                                            @forelse ($users as $user)
                                                @if (
                                                    $user->roles[0]->id >= auth()->user()->roles[0]->id &&
                                                        ($user->bidang_id == auth()->user()->bidang_id ||
                                                            auth()->user()->roles[0]->name == 'Super Admin' ||
                                                            auth()->user()->roles[0]->name == 'Kepala Dinas'))
                                                    <tr>
                                                        <td
                                        ...
                                        text-overflow: ellipsis;
                                        white-space: nowrap;"
                                                            class="text-wrap">{{ $user->bidang->name ?? '-' }}</td>
                                                        <td
                                                            style="overflow: hidden;
                                        text-overflow: ellipsis;
                                        white-space: nowrap;">
                                        ...
                                        text-overflow: ellipsis;
                                        white-space: nowrap;"
                                                            class="btn-action" style="width: 260px;">
                                                            @if ($user->roles[0]->name != 'Super Admin')
                                                                <button type="button"
                                                                    class="btn btn-block btn-light btn-sm text-black-50"
                                                                    data-toggle="modal"
                                                                    data-target="#modal-lg-reset-{{ $user->id }}"><i
                                                                        class="fas fa-cog"></i></button>
                                                                <button type="button" style="color: white;"
                                                                    class="btn btn-block btn-warning btn-sm"
                                                                    data-toggle="modal"
                                                                    data-target="#modal-lg-edit-{{ $user->id }}"><i
                                                                        class="fas fa-edit"></i></button>
                                                                @if (auth()->user()->id != $user->id)
                                                                    <button type="button"
                                                                        class="btn btn-block btn-danger btn-sm"
                                                                        data-toggle="modal"
                                                                        data-target="#modal-delete-{{ $user->id }}"><i
                                                        ...
                                                        <div class="modal fade" id="modal-lg-reset-{{ $user->id }}">
                                                            <form action="{{ route('backend.users.reset', $user->id) }}"
                                                                method="POST" id="reset_password">
                                                                @method('PUT')
                                                                @csrf
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"><strong> Reset Password
                                                                                    User </strong></h5>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            class="text-darkblue">Password</label><span
                                                                                            class="text-gray text-sm">
                                                                                            (Harus kombinasi huruf dan angka
                                                                                            minimum 6 karakter)</span>
                                                                                        <input type="password"
                                                                                            class="form-control"
                                                                                            name="password"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label class="text-darkblue">Ulangi
                                                                                            Password</label><span
                                                                                            class="text-gray text-sm">
                                                                                            (Harus kombinasi huruf dan angka
                                                                                            minimum 6 karakter)</span>
                                                        ...
                                                        <div class="modal fade" id="modal-lg-edit-{{ $user->id }}">
                                                            <form action="{{ route('backend.users.update', $user) }}"
                                                                method="POST" id="update_user">
                                                                @method('PUT')
                                                                @csrf
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"><strong> Edit Data User
                                                                                </strong></h5>
                                                                            <button type="button" class="close"
                                                                                data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    @if (auth()->user()->roles[0]->name != $user->roles[0]->name)
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                class="text-darkblue">Role/Level</label>
                                                                                    ...
                                                                                    @can('tambah pengguna bidang')
                                                                                        @if (auth()->user()->roles[0]->name != $user->roles[0]->name)
                                                                                            <div class="form-group">
                                                                                                <label
                                                                                                    class="text-darkblue">Bidang</label>
                                                                                                <select class="form-control"
                                                                                                    name="bidang_id">
                                                                                                    <option value=""
                                                                                                        selected disabled>--
                                                                                                    ...
                                                                                                    @foreach ($bidang as $bid)
                                                                                                        <option
                                                                                                            value="{{ $bid->id }}"
                                                                                                            {{ $user->bidang_id == $bid->id ? 'selected' : '' }}>
                                                                                                            {{ $bid->name }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            class="text-darkblue">Nama</label>
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            name="name"
                                                                                            value="{{ $user->name }}"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            class="text-darkblue">Username</label><span
                                                                                            class="text-gray text-sm">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            class="text-darkblue">Email</label>
                                                                                        <input type="email"
                                                                                            class="form-control"
                                                                                            name="email"
                                                                                            value="{{ $user->email }}"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            class="text-darkblue">Telepon</label>
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            name="phone_number"
                                                        ...
                                                        <div class="modal fade" id="modal-delete-{{ $user->id }}">
                                                            <form action="{{ route('backend.users.destroy', $user->id) }}"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"><strong> Hapus User
                                                                                </strong></h5>
                                                                            <button type="button" class="close"
                                                                                data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    <span class="text-gray">Anda yakin
                                                                                        Hapus data?</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        placeholder="Silahkan masukan nama pengguna" required>
                                </div>
                                <div class="form-group">
                                    <label class="text-darkblue">NIP</label>
                                    <input type="text" class="form-control" name="nip"
                                        placeholder="Silahkan masukan NIP" required>
                                </div>
                                <div class="form-group">
                                    <label class="text-darkblue">Username</label><span class="text-gray text-sm"> (Tidak
                                        boleh mengandung karakter khusus)</span>
                                    <input type="text" class="form-control" name="username"
                                        placeholder="Silahkan masukan username" required>
                                </div>
                                <div class="form-group">
                                    <label class="text-darkblue">Password</label><span class="text-gray text-sm"> (Harus
                                        kombinasi huruf dan angka minimum 6 karakter)</span>
                                    <input type="password" class="form-control" name="password"
                                        placeholder="Silahkan masukan password" required>
                                </div>
                                <div class="form-group">
                                    <label class="text-darkblue">Ulangi Password</label><span class="text-gray text-sm">
                                        (Harus kombinasi huruf dan angka minimum 6 karakter)</span>
