            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3 flex-md-row flex-column justify-content-md-between">
                        <div class="row mb-0">
                            <h4 class="text-darkblue mb-0"><strong> DATA URUSAN </strong></h4>
                        </div>
                        <div class="ml-2 mb-2 card-action-right d-flex justify-content-end ">
                            <button id="addurusan" class="btn btn-primary btn-sm btn-add" data-toggle="modal"
                                data-target="#modal-lg-create"><i class="fas fa-plus"></i> Tambah Urusan</button>
                        </div>
                    </div>
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill"
                                ...
                                aria-selected="true">Daftar urusan</a>
                        </li>
                    </ul>
                                    ...
                                    <table id="example1" class="table ">
                                        ...
                                        white-space: nowrap;">
                                                ...
                                                <div class="modal fade" id="modal-lg-edit-{{ $item->id }}">
                                                    <form action="{{ route('backend.urusan.update', $item->id) }}"
                                                        method="POST" id="update_urusan">
                                                        @method('PUT')
                                                        @csrf
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"><strong> Data Urusan </strong>
                                                                    </h5>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="name"
                                                                                    value="{{ $item->name }}"
                                                                                    placeholder="Silahkan masukan nama urusan"
                                                                                    required>
                                                                            </div>
                                                ...
                                                <div class="modal fade" id="modal-delete-{{ $item->id }}">
                                                    <form action="{{ route('backend.urusan.destroy', $item->id) }}"
                                                        method="POST" id="delete_urusan">
                                                        @method('DELETE')
                                                        @csrf
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"><strong> Hapus Urusan </strong>
                                                                    </h5>
                                                                    <button type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        placeholder="Silahkan masukan nama urusan" required>
                                </div>
