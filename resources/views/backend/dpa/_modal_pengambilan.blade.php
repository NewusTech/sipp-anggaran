<div class="modal fade" id="modal-lg-pengambilan">
	<div class="modal-dialog modal-lg">
		<form action="{{route('backend.pengambilan.store.dpa')}}" method="POST">
			@csrf
					...
					<div class="row">
							<div class="col-sm-12">
									...
									<div class="form-group">
											...
											<select name="bulan" id="bulan" class="form-control" onchange="getPengambilanByDpa('{{ $dpa->id }}', this.value)">
