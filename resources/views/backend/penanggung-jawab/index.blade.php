...
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-left">
        ...
        <li class="breadcrumb-item active "><span class="text-darkblue">{{ __('Pengaturan Penanggung Jawab') }}</span></li>
    </ol>
</div>
@endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-action-right">
                    <button id="addPenanggungJawab" class="btn btn-primary btn-sm btn-add" data-toggle="modal" data-target="#modal-lg-create"><i class="fas fa-plus"></i> Tambah Penanggung Jawab</button>
                </div>
                <div class="row">
                ...
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Daftar Penanggung Jawab</a>
                    </li>
                </ul>
                            ...
                            <div class="col-12 justify-content-center">
                                <table id="example1" class="table table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$item->pptk_name}}</td>
                                            <td>{{$item->pptk_email}}</td>
                                            <td>{{$item->pptk_telpon}}</td>
                                            <td>{{$item->ppk_name}}</td>
                                            <td class="btn-action">
