            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3 flex-md-row flex-column justify-content-md-between">
                        <div class="row mb-0">
                            <h4 class="text-darkblue mb-0"><strong> DATA PROGRAM </strong></h4>
                        </div>
                        <div class="ml-2 mb-2 card-action-right d-flex justify-content-end ">
                            <button id="addProgram" class="btn btn-primary btn-sm btn-add" data-toggle="modal"
                                data-target="#modal-lg-create"><i class="fas fa-plus"></i> Tambah Program</button>
                        </div>
                    </div>
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill"
                                ...
                                aria-selected="true">Daftar Program</a>
                        </li>
                    </ul>
                                    ...
                                    <table id="example1" class="table">
                                        ...
                                        white-space: nowrap;">
                                                ...
                                                <div class="modal fade" id="modal-lg-edit-{{ $item->id }}">
                                                    <form action="{{ route('backend.program.update', $item->id) }}"
                                                        method="POST" id="update_program">
                                                        @method('PUT')
                                                        @csrf
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"><strong> Data Program </strong>
                                                                    </h5>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="name"
                                                                                    value="{{ $item->name }}"
                                                                                    placeholder="Silahkan masukan nama program"
                                                                                    required>
                                                                            </div>
                                                ...
                                                <div class="modal fade" id="modal-delete-{{ $item->id }}">
                                                    <form action="{{ route('backend.program.destroy', $item->id) }}"
                                                        method="POST" id="delete_program">
                                                        @method('DELETE')
                                                        @csrf
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"><strong> Hapus Program
                                                                        </strong></h5>
                                                                    <button type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        placeholder="Silahkan masukan nama program" required>
                                </div>
