...
@section('breadcump')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
            ...
            <li class="breadcrumb-item active "><span class="text-darkblue">{{ __('Pengaturan Bidang') }}</span></li>
        </ol>
    </div>
@endsection
...
@section('main')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3 flex-md-row flex-column justify-content-md-between">
                        <div class="row mb-0">
                            <h4 class="text-darkblue mb-0"><strong> DATA BIDANG </strong></h4>
                        </div>
                        <div class="ml-2 mb-2 card-action-right d-flex justify-content-end ">
                            <button id="addBidang" class="btn btn-primary btn-sm btn-add" data-toggle="modal"
                                data-target="#modal-lg-create"><i class="fas fa-plus"></i> Tambah Bidang</button>
                        </div>
                    </div>
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill"
                                ...
                                aria-selected="true">Daftar Bidang</a>
                        </li>
                    </ul>
                                        ...
                                        <tbody>
                                            @foreach ($bidang as $item)
                                                ...
                                                <div class="modal fade" id="modal-lg-edit-{{ $item->id }}">
                                                    <form action="{{ route('backend.bidang.update', $item->id) }}"
                                                        method="POST" id="update_bidang">
                                                        @method('PUT')
                                                        @csrf
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"><strong> Data Bidang </strong>
                                                                    </h5>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="name"
                                                                                    value="{{ $item->name }}"
                                                                                    placeholder="Silahkan masukan nama bidang"
                                                                                    required>
                                                                            </div>
                                                ...
                                                <div class="modal fade" id="modal-delete-{{ $item->id }}">
                                                    <form action="{{ route('backend.bidang.destroy', $item->id) }}"
                                                        method="POST" id="delete_bidang">
                                                        @method('DELETE')
                                                        @csrf
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"><strong> Hapus Bidang </strong>
                                                                    </h5>
                                                                    <button type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
    ...
    <div class="modal fade" id="modal-lg-create">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong> Data Bidang </strong></h5>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        placeholder="Silahkan masukan nama bidang" required>
                                </div>
