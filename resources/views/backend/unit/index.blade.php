...
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-left">
        ...
        <li class="breadcrumb-item active "><span class="text-darkblue">{{ __('Pengaturan Unit') }}</span></li>
    </ol>
</div>
@endsection
        ...
        <div class="card">
            <div class="card-body">
								<div class="card-action-right">
									<button id="addunit" class="btn btn-primary btn-sm btn-add" data-toggle="modal" data-target="#modal-lg-create"><i class="fas fa-plus"></i> Tambah Unit</button>
								</div>
                <div class="row">
                    <h4 class="text-darkblue"><strong> DATA UNIT </strong></h4>
                </div>
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    <li class="nav-item">
                    <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Daftar unit</a>
                    </li>
                </ul>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table id="example1" class="table ">
                                    <thead>
                                    <tr>
                                        <th style="width: 80%; padding:1rem 2.25rem;">Nama Unit</th>
                                    ...
                                    <div class="modal fade" id="modal-lg-edit-{{$item->id}}" style="padding-right: 17px; ">
                                        <form action="{{ route('backend.unit.update', $item->id) }}" method="POST" id="update_unit">
                                            @method('PUT')
                                            @csrf
                                            <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title"><strong> Data Unit </strong></h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                        <label class="text-darkblue">Nama Unit</label>
                                                        <input type="text" class="form-control" name="name" value="{{$item->name}}" placeholder="Silahkan masukan nama unit" required>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="modal-delete-{{$item->id}}" style="padding-right: 17px; ">
                                        <form action="{{ route('backend.unit.destroy', $item->id) }}" method="POST" id="delete_unit">
                                            @method('DELETE')
                                            @csrf
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title"><strong> Hapus Unit </strong></h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
...
<div class="modal fade" id="modal-lg-create" style="padding-right: 17px; ">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('backend.unit.store') }}" method="POST" id="submit_unit">
                @csrf
                <div class="row">
                  <div class="col-sm-12">
                    <!-- text input -->
                    ...
                    <div class="form-group">
                      <label class="text-darkblue">Nama Unit</label>
                      <input type="text" class="form-control" name="name" placeholder="Silahkan masukan nama unit" required>
                    </div>
                    <span class="text-gray">*Tidak boleh mengandung karakter khusus</span>
                  </div>
                </div>
