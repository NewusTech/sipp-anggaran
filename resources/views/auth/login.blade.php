        ...
        <div class="card-body login-card-body bg-gradient-blue">
            ...
            <div class="row login-box-msg">
                <div style="color: black">
                    <div class="d-flex mt-5 mb-4">
                        <img
                        src="{{ asset('image/logo-pu-new.png') }}"
                        alt="PUPR Logo"
                        class="login-img"
                        />
                        <div class="title-logo-pu">
                            <h2>PU-Net</h2>
                            <p>Dinas Bina Marga Provinsi Lampung</p>
                        </div>
                    </div>
            ...
            <form class="form-login" action="{{ route('login') }}" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="email" class="form-control rounded login-input @error('email') is-invalid @enderror"
                        placeholder="Email" value="{{ old('email') }}" autofocus required autocomplete="false">
                    @error('email')
                ...
                <div class="input-group mb-3">
                    <input type="password" name="password" class="form-control rounded login-input @error('password') is-invalid @enderror"
